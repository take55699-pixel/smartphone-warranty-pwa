const CACHE_NAME='smartphone-warranty-pwa-v2';
const APP_SHELL=['./','./index.html','./data.js','./extra-data.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
